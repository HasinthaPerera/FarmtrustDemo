  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        setContactInfo({ email: parsed.email || 'support@farmtrust.lk', phone: parsed.phone || '+94 77 123 4567' });
      } catch(e) {}
    }
  }, []);
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex flex-col gap-3">
                <a href={`mailto:${contactInfo.email}`} className="inline-flex items-center gap-3 text-slate-400 hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  {contactInfo.email}
                </a>
                <a href={`tel:${contactInfo.phone.replace(/[^0-9+]/g, '')}`} className="inline-flex items-center gap-3 text-slate-400 hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4 text-base">
                ...
                <li><a href={`mailto:${contactInfo.email}`} className="text-slate-400 hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
